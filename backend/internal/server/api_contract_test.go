...
func (r *stubUsageLogRepo) GetAPIKeyDetailedStatsAggregated(ctx context.Context, apiKeyID int64, startTime, endTime time.Time) (*usagestats.DetailedUsageStats, error) {
	return nil, errors.New("not implemented")
}
