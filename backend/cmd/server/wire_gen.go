...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	publicHandler := handler.NewPublicHandler(usageService, apiKeyService)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, publicHandler)
